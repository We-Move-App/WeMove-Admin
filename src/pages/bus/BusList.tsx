...
import { Bus, BusOperator } from '@/types/admin';
...
const BusList = () => {
  ...
  const columns = [
    { key: 'registrationNumber' as keyof Bus, header: 'Registration No.' },
    { key: 'type' as keyof Bus, header: 'Bus Type' },
    { key: 'capacity' as keyof Bus, header: 'Capacity' },
    { key: 'status' as keyof Bus, header: 'Status' },
    { key: 'route' as keyof Bus, header: 'Route' },
    { key: 'manufactureYear' as keyof Bus, header: 'Year' },
    { key: 'lastMaintenance' as keyof Bus, header: 'Last Maintenance' },
    { key: 'insuranceValidTill' as keyof Bus, header: 'Insurance Valid Till' },
    {
