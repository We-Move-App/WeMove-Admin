...
const NotificationsManagement = () => {
  ...
  const [scheduledEmails, setScheduledEmails] =
    useState<ScheduledEmail[]>(mockScheduledEmails);
  ...
  const handleSaveScheduledEmail = () => {
    const template = templates.find(
      (t) => t.id === newScheduledEmail.templateId
    );
    ...
    toast({
      ...
      description: `Email has been scheduled for ${new Date(
        newScheduledEmail.scheduledFor
      ).toLocaleString()}`,
    });
  ...
  return (
    <>
      <div className="p-6">
          ...
          <TabsContent value="scheduled">
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>
                  Track your upcoming marketing campaigns
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-blue-50 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-blue-700">
                      {
                        scheduledEmails.filter((e) => e.status === "pending")
                          .length
                      }
                    </p>
                  </div>
                  <div className="bg-green-50 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-green-700">
                      {
                        scheduledEmails.filter((e) => e.status === "sent")
                          .length
                      }
                    </p>
                  </div>
                  <div className="bg-red-50 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-red-700">
                      {
                        scheduledEmails.filter((e) => e.status === "failed")
                          .length
                      }
                    </p>
                  </div>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500 mb-2">
                      ...
                      <code className="bg-gray-100 px-1 mx-1">
                        {"{{customer_name}}"}
                      </code>
                      ,
                      <code className="bg-gray-100 px-1 mx-1">
        ...
        <Dialog
          open={isScheduling}
          onOpenChange={(open) => !open && setIsScheduling(false)}
        >
          <DialogContent>
            <DialogHeader>
                    ...
                    onCheckedChange={(checked) => {
                      setNewScheduledEmail({
                        ...
                        filterOptions: {
                          ...
                          inactiveCustomers:
                            newScheduledEmail.filterOptions.inactiveCustomers,
                        },
                      });
                    }}
                    disabled={newScheduledEmail.filterOptions.allCustomers}
                  />
                  <Label htmlFor="active-customers">
                    ...
                    onCheckedChange={(checked) => {
                      setNewScheduledEmail({
                        ...
                        filterOptions: {
                          allCustomers: false,
                          activeCustomers:
                            newScheduledEmail.filterOptions.activeCustomers,
            ...
            <DialogFooter>
              ...
              <Button
                onClick={handleSaveScheduledEmail}
                className="flex items-center"
              >
